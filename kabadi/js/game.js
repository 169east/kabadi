...
function raiderObj(color, sz, speed, controls){
	...
	this.collide = function(enemy){
		...
		this.overlap = collideCircleCircle(this.x,this.y,this.d-siCatch,enemy.x,enemy.y,enemy.d) // are we overlapping with the enemy?
...
function untiObj(color, sz, untiX, untiY){
	this.x = untiX;
	this.y = untiY;
	/*this.linex;
	this.liney;
